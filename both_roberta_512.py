...
os.makedirs("saved_data_tokenz_512", exist_ok=True)
        ...
        for batch in train_iter:
            ...
            if global_step % valid_period == 0:
                ...
                if best_valid_loss > valid_loss:
                    ...
                    save_path = output_path + '/model_both_reg_512.pkl'
                    save_checkpoint(save_path, model, best_valid_loss)
                    save_path = output_path + '/metric_both_reg_512.pkl'
...
train_loss_list, valid_loss_list, global_steps_list = load_metrics(output_path + '/metric_both_reg_512.pkl', device)
plt.plot(global_steps_list, train_loss_list, label='Train')
plt.plot(global_steps_list, valid_loss_list, label='Valid')
plt.xlabel('Global Steps', fontsize=14)
plt.ylabel('Loss', fontsize=14)
plt.legend(fontsize=14)
plt.savefig('loss_both_reg_512.png', dpi=500)
...
_, X_eval_sum = tokenize_df(tokenizer, X_eval, max_len = 512, col = "summary")
_, X_eval_doc = tokenize_df(tokenizer, X_eval, max_len = 512, col = "document")
print("\t\t training dset has been tokenized !!!")
...
X_eval_ids_sum = np.load(output_path + "/" + 'X_eval_sum_ids_512.npy')
X_eval_att_sum = np.load(output_path + "/" + "X_eval_sum_att_512.npy")
X_eval_ids_doc = np.load(output_path + "/" + 'X_eval_doc_ids_512.npy')
X_eval_att_doc = np.load(output_path + "/" + "X_eval_doc_att_512.npy")
...
with open("submission_RobertaImad_BothSumDoc_512_regularized.csv", "w") as pred:
